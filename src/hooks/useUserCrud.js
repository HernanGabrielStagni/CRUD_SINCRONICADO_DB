...
const useUserCrud = () =>{
   const [users, setUser] = useState() //para guardar la info de la api
    ...
    const url="https://ent-2-node-crud-users-dev-scej.1.us-1.fl0.io/users" //netlify no deja si el sitio no es https
    ...
    const updateUserById = (id,data) =>{
       ...
       const urlUpdate=`${url}/${id}`
         axios.put(urlUpdate,data) //ubica el usuario y lo actualiza 
